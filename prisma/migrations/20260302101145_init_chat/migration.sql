/*
  ...
  - You are about to drop the `ChatContext` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "ChatContext" DROP CONSTRAINT "ChatContext_thread_id_fkey";

-- DropForeignKey
ALTER TABLE "ChatMessage" DROP CONSTRAINT "ChatMessage_thread_id_fkey";

-- DropTable
DROP TABLE "ChatContext";
